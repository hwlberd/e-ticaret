                  ...
                  <div class="x_content">
                    ...
                    <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Menü Ad :</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" name="menu_ad"
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="menu_durum" id="heard" class="form-control">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Menü URL :</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" name="menu_url"
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Menü Sıra :</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" name="menu_sira"
