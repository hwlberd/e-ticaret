        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Kayyrum Royal Admin Panel</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-cogs"></i> Site Ayarları <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="iletisimayar.php">İletişim Ayarlar</a></li>
                      <li><a href="apiayar.php">Api Ayarlar</a></li>
                      <li><a href="sosyalayar.php">Sosyal Ayarlar</a></li>
                      <li><a href="mailayar.php">Mail Ayarlar</a></li>
