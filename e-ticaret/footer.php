			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						<li class="fphone"><?php echo $ayarcek['ayar_tel']
                              ?></li>
						<li class="fmobile"><?php echo $ayarcek['ayar_gsm']
                              ?></li>
						<li class="fmail lastone"><?php echo $ayarcek['ayar_mail']
                              ?></li>
					</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author'] ?> <a href="index.php">kayyumroyal.com</a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href="<?php echo $ayarcek['ayar_youtube'] ?>" class="fyoutube">Youtube</a>

						<a href="<?php echo $ayarcek['ayar_google'] ?>" class="fgoogle">Google</a>
